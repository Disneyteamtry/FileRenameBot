class Translation(object):
    START_TEXT = """ <b> Hi {} , \nI'm IBOMMA File Renamer With Permanent Tumbnail & Custom Caption support!</b> \n
Send me File Or Video And Reply To It As /rename with File Name Check Help For More Information

<b>Maintained By: @Ibomma1947 </b> \n 
"""

    BANNED_USER_TEXT = "Sorry!! But Mai Owner As Banned You From Using This Service. That Means You Can't Run Meh Now! \n \n Contact : @disneyteamchat For more Details.. " 
    DOWNLOAD_START = "<b>Downloading To My server !! Plz Wait</b>"
    UPLOAD_START = "<b>Downloading Completed Now I'm Uploading Into TeleGram Thanks For Your Patience😊</b>"
    AFTER_SUCCESSFUL_UPLOAD_MSG = "<b>Thank you for Using Me Support Our Channel @Ibomma1947 ❤️</b>"
